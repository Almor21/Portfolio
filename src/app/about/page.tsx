	...
	return (
		<div className="grid grid-cols-[repeat(2,1fr)] gap-16">
			<div className="justify-self-end w-1/2 flex flex-col items-center text-white">
				<div
					className={`${style.rotate} p-1 border-2 border-[white_transparent_white_white] rounded-full transition-all duration-500`}
				>
					<div className="p-1 border-2 border-[white_white_white_transparent] rounded-full overflow-hidden transition-all duration-500">
						<div className='relative h-28 w-28'>
							<Image
								src={'/VoidPhoto.jpeg'}
								alt="Profile image"
								fill={true}
								className="rounded-full filter grayscale transition-all duration-500"
							/>
						</div>
					</div>
				</div>
